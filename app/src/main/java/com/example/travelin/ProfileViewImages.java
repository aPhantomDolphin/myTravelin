...
public class ProfileViewImages extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.navigation_home:
                        ...
                        intent = new Intent(ProfileViewImages.this, HomeActivity.class);
                    ...
                    case R.id.navigation_search:
                        intent = new Intent(ProfileViewImages.this, SearchFilterActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        try{
                            startActivity(intent);
                        }catch (Exception e){
                    ...
                    case R.id.navigation_forum:
                        intent = new Intent(ProfileViewImages.this, ForumMainActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        return true;

                    case R.id.navigation_profile:
                        intent = new Intent(ProfileViewImages.this, ProfileActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        return true;
