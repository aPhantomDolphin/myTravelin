    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        createPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //final Post creatingPost = new Post(mAuth.getCurrentUser().getEmail(), currentDate, postDesc.getText().toString(), newPostRef.getKey() ,postTitle.getText().toString());
                //StringBuilder postUserName = new StringBuilder();
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                            ...
                            if (mAuth.getCurrentUser().getEmail().equals(user.getEmail())) {
                                System.out.println("IN USEr USERNAME "+user.getUsername());
                                //postUserName.append(user.getUsername());
                                Post creatingPost = new Post(mAuth.getCurrentUser().getEmail(), currentDate, postDesc.getText().toString(), newPostRef.getKey() ,postTitle.getText().toString(), user.getUsername());
                                //creatingPost.setUsername(user.getUsername());
                                System.out.println("AFTER set: "+creatingPost.getUsername());
